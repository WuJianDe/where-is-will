...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $statement = db()->prepare('SELECT name, time_ms, created_at FROM where_is_will_scores ORDER BY time_ms ASC, created_at ASC LIMIT :limit');
...
try {
    $statement = db()->prepare('INSERT INTO where_is_will_scores (name, email, time_ms) VALUES (:name, :email, :time_ms)');
